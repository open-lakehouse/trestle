...
impl ::core::convert::From<super::catalog::v1::CatalogType> for PyCatalogType {
    fn from(value: super::catalog::v1::CatalogType) -> Self {
        PyCatalogType::__from_proto_i32(
            <super::catalog::v1::CatalogType as ::buffa::Enumeration>::to_i32(&value),
        )
    }
}
impl ::core::convert::From<PyCatalogType> for super::catalog::v1::CatalogType {
    fn from(value: PyCatalogType) -> Self {
        ...
        <super::catalog::v1::CatalogType as ::buffa::Enumeration>::from_i32(n)
            .unwrap_or_default()
    }
}
#[allow(non_camel_case_types)]
#[::pyo3::pyclass(eq, eq_int, name = "GetSchemaRequestView")]
#[derive(Clone, Copy, PartialEq, Eq, Hash, Debug)]
...
#[allow(non_camel_case_types)]
#[::pyo3::pyclass(eq, eq_int, name = "SchemaType")]
#[derive(Clone, Copy, PartialEq, Eq, Hash, Debug)]
...
impl ::core::convert::From<super::schemas::v1::SchemaType> for PySchemaType {
    fn from(value: super::schemas::v1::SchemaType) -> Self {
        PySchemaType::__from_proto_i32(
            <super::schemas::v1::SchemaType as ::buffa::Enumeration>::to_i32(&value),
        )
    }
}
impl ::core::convert::From<PySchemaType> for super::schemas::v1::SchemaType {
    fn from(value: PySchemaType) -> Self {
        let n = value.__to_proto_i32();
        <super::schemas::v1::SchemaType as ::buffa::Enumeration>::from_i32(n)
            .unwrap_or_default()
    }
}
#[::pyo3::pyclass(name = "AzureConfig")]
#[derive(Clone, Debug)]
...
impl PyCatalog {
    ...
    fn new(
        ...
        if let ::core::option::Option::Some(value) = catalog_type {
            inner.catalog_type = ::buffa::EnumValue::Known(
                <super::catalog::v1::CatalogType as ::core::convert::From<
                    _,
                >>::from(value),
            );
        }
    ...
    fn catalog_type(&self) -> PyCatalogType {
        PyCatalogType::from(self.0.catalog_type.as_known().unwrap_or_default())
    }
    #[getter]
    fn properties(
        &self,
    ...
    fn storage_config(&self) -> ::core::option::Option<PyStorageConfig> {
        self.0.storage_config.clone().into_option().map(PyStorageConfig::from)
    }
    #[getter]
    ...
    fn set_catalog_type(&mut self, value: PyCatalogType) {
        self.0.catalog_type = ::buffa::EnumValue::Known(
            <super::catalog::v1::CatalogType as ::core::convert::From<_>>::from(value),
        );
    }
    #[setter(properties)]
    fn set_properties(
...
#[::pyo3::pyclass(name = "CatalogStatus")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "CatalogToken")]
#[derive(Clone, Debug)]
...
impl PyCreateCatalogRequest {
    ...
    fn catalog(&self) -> ::core::option::Option<PyCatalog> {
        self.0.catalog.clone().into_option().map(PyCatalog::from)
    }
    #[setter(catalog)]
    fn set_catalog(&mut self, value: ::core::option::Option<PyCatalog>) {
        self.0.catalog = value
            .map(|w| ::buffa::MessageField::some(w.into()))
            .unwrap_or_default();
    }
    fn __repr__(&self) -> ::std::string::String {
...
#[::pyo3::pyclass(name = "DeleteCatalogResponse")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "GenerateCatalogTokenRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "GetCatalogStatusRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "ListByCatalogTypeRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "ListByTagsRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "ListByTagsResponse")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "StorageConfig")]
#[derive(Clone, Debug)]
...
impl PyCreateSchemaRequest {
    ...
    fn new(
        ...
        if let ::core::option::Option::Some(value) = schema_type {
            inner.schema_type = ::buffa::EnumValue::Known(
                <super::schemas::v1::SchemaType as ::core::convert::From<_>>::from(value),
            );
        }
        Self(inner)
    }
    ...
    fn schema_type(&self) -> PySchemaType {
        PySchemaType::from(self.0.schema_type.as_known().unwrap_or_default())
    }
    #[setter(name)]
    fn set_name(&mut self, value: ::std::string::String) {
        self.0.name = value;
    ...
    fn set_schema_type(&mut self, value: PySchemaType) {
        self.0.schema_type = ::buffa::EnumValue::Known(
            <super::schemas::v1::SchemaType as ::core::convert::From<_>>::from(value),
        );
    }
    fn __repr__(&self) -> ::std::string::String {
...
#[::pyo3::pyclass(name = "DeleteSchemaResponse")]
#[derive(Clone, Debug)]
...
impl PyGetSchemaRequest {
    ...
    fn view(&self) -> PyGetSchemaRequestView {
        PyGetSchemaRequestView::from(self.0.view.as_known().unwrap_or_default())
    }
    #[setter(full_name)]
    fn set_full_name(&mut self, value: ::std::string::String) {
        self.0.full_name = value;
...
impl PyUpdateSchemaRequest {
    ...
    fn schema(&self) -> ::core::option::Option<PySchema> {
        self.0.schema.clone().into_option().map(PySchema::from)
    }
    #[setter(full_name)]
    fn set_full_name(&mut self, value: ::std::string::String) {
        self.0.full_name = value;
...
#[::pyo3::pyclass(name = "CreateTagAssignmentRequest")]
#[derive(Clone, Debug)]
...
impl PyCreateTagAssignmentRequest {
    ...
    fn tag(&self) -> ::core::option::Option<PyTagAssignment> {
        self.0.tag.clone().into_option().map(PyTagAssignment::from)
    }
    #[setter(entity_type)]
...
#[::pyo3::pyclass(name = "DeleteTagAssignmentRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "DeleteTagAssignmentResponse")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "GetTagAssignmentRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "ListTagAssignmentsRequest")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "ListTagAssignmentsResponse")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "TagAssignment")]
#[derive(Clone, Debug)]
...
#[::pyo3::pyclass(name = "TouchTagAssignmentRequest")]
#[derive(Clone, Debug)]
