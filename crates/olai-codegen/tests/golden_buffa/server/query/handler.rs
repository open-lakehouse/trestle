...
//! Handler trait for [`QueryHandler`].
//!
...
//!
//! Resource-less service of custom query RPCs (no `google.api.resource`), used to exercise
//! repeated/enum query-param generation and `RequestType::Custom` classification.
use async_trait::async_trait;
use crate::Result;
use example_common::models::catalog::v1::*;
#[async_trait]
pub trait QueryHandler<Cx = crate::Context>: Send + Sync + 'static {
