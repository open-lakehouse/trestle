...
//! `crate::connect`) by delegating to the SAME [`GreetingCore`] the REST
...
//!
//! NOTE: this references generated code under `crate::connect`, so run
...
use crate::connect::golden_path_app::v1::GreetingService;
